 ...
 */
class Cellable_Defect_Group_List_Table extends WP_List_Table {
                ...
                case 'delete':
                    if(is_array($_GET['item'])) {
                        foreach ($_GET['item'] as $item){
                            delete_defect_group($item);
                        }                        
                    }
                    else {
                        delete_defect_group($_GET['item']);
                    }
                    ?><div id="message" class="updated notice is-dismissible"><p><?php _e( 'Selected Defect Group Deleted.' );?></p></div><?php
                    break;
                default:
                    break;
            }
 ...
 */
function render_defect_group_list(){

    if(isset($_GET['action']) && $_GET['action'] == 'edit')
    {
        $id = $_GET['item'];        
        render_edit_defect_group_page($id);
        return;
    }

    if(isset($_GET['action']) && $_GET['action'] == 'new')
    {        
        render_new_defect_group_page();
        return;
    }

    //Create an instance of our package class...
    $phone_list_table = new Cellable_Defect_Group_List_Table();
    ...
    <div class="wrap">
        ...
        <form id="versions-filter" method="get">
            ...
            <?php $phone_list_table->search_box('Search','defect_group_id');?>
...
function delete_defect_group($id){
    global $wpdb;
    $wpdb->delete($wpdb->base_prefix.'cellable_defect_groups', array('id' => $id));
}

 ...
 */
class Cellable_Carrier_List_Table extends WP_List_Table {
            ...
            switch($this->current_action()){
                case 'delete':
                    if(is_array($_GET['item'])) {
                        ...
                        delete_carrier($_GET['item']);
                    }
                    ?><div id="message" class="updated notice is-dismissible"><p><?php _e( 'Selected Carrier Deleted.' );?></p></div><?php
                    break;
                default:
                    break;
            }
 ...
 */
function render_carrier_list(){

    if(isset($_GET['action']) && $_GET['action'] == 'edit')
    {
        $id = $_GET['item'];        
        render_edit_carrier_page($id);
        return;
    }

    if(isset($_GET['action']) && $_GET['action'] == 'new')
    {        
        render_new_carrier_page();
        return;
    }

    //Create an instance of our package class...
    $list_table = new Cellable_Carrier_List_Table();
    ...
    <div class="wrap">
        ...
        <form id="carriers-filter" method="get">
            ...
            <?php $list_table->search_box('Search','carrier_id');?>
